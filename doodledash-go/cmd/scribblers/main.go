...
import (
	...
	"github.com/chirp/doodledash/internal/frontend"
	"github.com/chirp/doodledash/internal/state"
	"github.com/chirp/doodledash/internal/version"
)
...
func main() {
	...
	log.Printf("Starting DoodleDash by Fahad Khan (cybe4sent1nel) - version '%s'\n", version.Version)
