...
import { Home, MessageCircle, Search, UserIcon, Users, Bell, Info, Sparkles, Newspaper, BookOpen, Wind } from 'lucide-react'
...
export const menuItemsData = [
    ...
    { 
        ...
        Icon: Newspaper,
        submenu: [
            { to: '/chirp-news', label: 'Headlines', Icon: Newspaper },
            { to: '/chirp-articles', label: 'Articles', Icon: BookOpen }
        ]
    },
    { to: '/chirp-channels', label: 'Chirp Channels', Icon: Wind },
