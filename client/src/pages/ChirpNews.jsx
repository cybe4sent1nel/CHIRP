...
import { Newspaper, Search, Loader, Calendar, ExternalLink } from "lucide-react";
...
const ChirpNews = () => {
  ...
  const fetchNews = async (query = searchQuery, cat = category) => {
    setLoading(true);
    setError(null);
    ...
    try {
      ...
      // Only send search query if it's different from default category or explicitly searched
      ...
      const response = await fetch(
        `${import.meta.env.VITE_BASEURL}/api/news/search?${params.toString()}`
      );
      ...
      <div className="bg-white border-b border-gray-200 sticky top-0 z-10 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 py-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Chirp News</h1>
              <p className="text-sm text-gray-500">
                Stay updated with latest news and trending stories
              </p>
            </div>
          </div>
              ...
              >
                ...
                <div className="p-5 flex flex-col flex-grow">
                  ...
                  <div className="flex items-center gap-2 mb-3 flex-wrap">
                    <span className="bg-indigo-100 text-indigo-700 text-xs font-semibold px-2.5 py-1 rounded-full whitespace-nowrap">
                  ...
                  {/* Title */}
                  <h3 className="text-base font-bold text-gray-900 mb-2 line-clamp-2 group-hover:text-indigo-600 min-h-[3.5rem]">
                    {article.title}
                  </h3>
