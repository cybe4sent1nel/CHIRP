...
const UserManagement = () => {
    ...
    const fetchUsers = async () => {
        try {
            ...
            const { data } = await api.get('/api/admin/users?limit=100', {
            ...
            if (data.success) {
                ...
                console.log('[DEBUG] Setting users:', usersList.length);
                setUsers(usersList);
            ...
            <div className="bg-white rounded-lg shadow overflow-hidden">
                {filteredUsers && filteredUsers.length > 0 ? (
                            ...
                            <tbody className="divide-y divide-gray-200">
                                {filteredUsers.map((user) => (
                                    <tr key={user._id} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        {/* Role */}
                                        <td className="px-6 py-4">
                                            <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${user.role === 'admin' || user.role === 'super_admin'
                    ...
                    <div className="p-8 text-center text-gray-500">
                        ...
                        <p className="text-sm mt-2">The user management API endpoint may not be configured yet.</p>
                    </div>
                )}
            </div>
