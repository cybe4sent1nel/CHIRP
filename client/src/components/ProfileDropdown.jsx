...
import { User, Settings, ChevronDown, Shield } from 'lucide-react';
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            >
                ...
                <ChevronDown
                    className={`w-4 h-4 text-gray-500 transition-transform duration-200 hidden md:block ${isOpen ? 'rotate-180' : ''
                        }`}
                />
            </button>
