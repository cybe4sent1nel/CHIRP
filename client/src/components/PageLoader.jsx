...
const Loader = ({ onTimeout, timeoutDuration = 240000 }) => {
  ...
  const wittyMessages = [
    ...
    "Waking up the internet fairies...",
    "Brewing some awesome sauce...",
    "Summoning the code gods...",
    "Polishing the digital mirrors...",
    "Dancing with algorithms...",
    "Whispering to the servers...",
    "Crafting moments, loading dreams..."
  ];
...
const StyledWrapper = styled.div`
  ...
  .candle1 {
    ...
    box-shadow: -2px 0px 0px #FFE5E5 inset;
  ...
  .candle2 {
    ...
    transform-origin: center right;
    box-shadow: -2px 0px 0px #D4FFD4 inset;
  ...
  .light__wave {
    ...
    border: 2px solid rgba(255, 200, 124, 0.3);
  ...
  @keyframes shake-left {
    ...
    91% {
      ...
      background: #90EE90;
      border-color: #90EE90;
      box-shadow: -2px 0px 0px #90EE90 inset;
    }
    92% {
      left: 20%;
  ...
  @keyframes expand-light {
    ...
    89% {
      ...
      border: 2px solid rgba(255, 200, 124, 0);
    }
    90%,
    20%,
    50% {
    ...
    57% {
      ...
      border: 2px solid rgba(255, 200, 124, 0.5);
    }
    0%,
    28%,
    58%,
  ...
  @keyframes dance-fire {
    ...
    58% {
      ...
      width: 16px;
      height: 20px;
      background: linear-gradient(to top, #ff7043, #ffc107);
    }
  }
